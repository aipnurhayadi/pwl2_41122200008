...
import LecturerPreferencesRedirect from "@/pages/LecturerPreferences";
    ...
    if (isLecturer) {
      return (
        <Routes>
          ...
          <Route path="/datasets/:datasetId/preferences" element={<ProtectedRoute><LecturerPreferencesRedirect /></ProtectedRoute>} />
          <Route path="*" element={<Navigate to="/my-datasets" replace />} />
        </Routes>
      );
    }
